...
| `khtpm-core/` | 🧰 The REAL, working parser/draw code (not a toy) — your agent wires this in rather than writing a chtpm parser from scratch. Includes a real example `.chtpm` file. |
